...
def load_model():
    ...
    if model == "1":
        ...
        return PPO.load(MODEL_BASE_PATH + "18_easier_map_mid_training/model.zip")
    elif model == "20":
        return PPO.load(MODEL_BASE_PATH + "20_short__memory_reverted_log_std_init_out/model.zip")
    elif model == "21":
        return PPO.load(MODEL_BASE_PATH + "21_history_length_1/model.zip")
    elif model == "22":
        return PPO.load(MODEL_BASE_PATH + "22_anti_stutter_short/model.zip")
    elif model == "23":
        ...
        return PPO.load(MODEL_BASE_PATH + "26_fix_shaping/model.zip")
    elif model == "27":
        return PPO.load(MODEL_BASE_PATH + "27_has_ground_below/model.zip")
    else:
